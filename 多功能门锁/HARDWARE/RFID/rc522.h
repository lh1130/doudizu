...
/***********************RC522 函数宏定义**********************/
#define          RC522_CS_Enable()         GPIO_ResetBits ( GPIOA, GPIO_Pin_0 )
#define          RC522_CS_Disable()        GPIO_SetBits ( GPIOA, GPIO_Pin_0 )

#define          RC522_Reset_Enable()      GPIO_ResetBits( GPIOB, GPIO_Pin_0 )
#define          RC522_Reset_Disable()     GPIO_SetBits ( GPIOB, GPIO_Pin_0 )

#define          RC522_SCK_0()             GPIO_ResetBits( GPIOA, GPIO_Pin_8 )
#define          RC522_SCK_1()             GPIO_SetBits ( GPIOA, GPIO_Pin_8 )

#define          RC522_MOSI_0()            GPIO_ResetBits( GPIOA, GPIO_Pin_1 )
#define          RC522_MOSI_1()            GPIO_SetBits ( GPIOA, GPIO_Pin_1 )

#define          RC522_MISO_GET()          GPIO_ReadInputDataBit ( GPIOA, GPIO_Pin_14 )
